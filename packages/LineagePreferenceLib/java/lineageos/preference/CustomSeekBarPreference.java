...
public abstract class CustomSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void updateValueViews() {
        ...
        if (mMinusImageView != null) {
            if (mValue == mMinValue || mTrackingTouch) {
                TypedArray ta = getContext().obtainStyledAttributes(new int[]{android.R.attr.textColorTertiary});
                int colorFilter = ta.getColor(0, 0);
                ta.recycle();

                mMinusImageView.setClickable(false);
                mMinusImageView.setColorFilter(colorFilter, PorterDuff.Mode.SRC_IN);
            } else {
        ...
        if (mPlusImageView != null) {
            if (mValue == mMaxValue || mTrackingTouch) {
                ...
                mPlusImageView.setColorFilter(colorFilter, PorterDuff.Mode.SRC_IN);
            } else {
