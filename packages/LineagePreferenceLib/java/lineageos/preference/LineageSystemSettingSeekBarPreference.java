...
public class LineageSystemSettingSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public LineageSystemSettingSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
    ...
    protected void init(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.lineage_SeekBarPreference);
        ...
        Integer id = a.getResourceId(R.styleable.lineage_SeekBarPreference_units, 0);
        if (id > 0) {
